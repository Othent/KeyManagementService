...
export const getAuth0Client = (): Promise<Auth0Client> => createAuth0Client({
...
export function getTokenSilently(auth0: Auth0Client, authParams: CustomAuthParams): Promise<GetTokenSilentlyVerboseResponse> {
